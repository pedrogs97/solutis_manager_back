...
class SchedulerService:
    ...
    FROM [SINESTRO].[CorporeRM].[dbo].[IPATRIMONIO] AS p
    ...
    SQL_IPATRIMONIO_TO_DELETE = """SELECT IDPATRIMONIO FROM [SINESTRO].[CorporeRM].[dbo].[IPATRIMONIO] WHERE IDPATRIMONIO = %s"""
